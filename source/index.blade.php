    ...
    <section class="home">
        <div class="container">
            ...
            <ul class="list">
                ...
                <li class="list__item">
                    currently open to freelance / contract work ✨
                </li>

                <li class="list__item">
                    product experience @ <a href="https://cv-library.co.uk" title="opens their site in new window" class="link" target="_blank">CV Library.</a>
                </li>
